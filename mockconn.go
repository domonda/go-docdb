...
type MockConn struct {
	...
	CreateDocumentMock              func(ctx context.Context, companyID, docID, userID uu.ID, reason string, files []fs.FileReader) (*VersionInfo, error)
...
func (mock *MockConn) CreateDocument(ctx context.Context, companyID, docID, userID uu.ID, reason string, files []fs.FileReader) (*VersionInfo, error) {
	return mock.CreateDocumentMock(ctx, companyID, docID, userID, reason, files)
}
